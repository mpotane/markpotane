export default function Footer() {
  return (
    <footer className="pt-6 w-full mx-auto">
      <div className="grid gap-2 row-gap-6 mb-8 grid-cols-1 md:grid-cols-2 lg:grid-cols-3">
        <div>
          <a
            href="/"
            aria-label="Go home"
          ...
          <div className="mt-1 lg:max-w-sm">
            <p className="text-sm text-slate-300">
              We empower businesses to tap into untapped markets. Let us be the
        ...
        <div>
          ...
          <div className="flex items-center mt-1 space-x-3">
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              href="https://twitter.com/mpotanedev"
              className="transition-colors duration-300 hover:text-orange-400"
            >
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              href="https://instagram.com/mpotanedev"
              className="transition-colors duration-300 hover:text-orange-400"
            >
            ...
            <a
              title="facebook link footer"
              target="_blank"
              rel="noopener noreferrer"
              href="https://www.facebook.com/profile.php?id=61554231201073"
              className="transition-colors duration-300 hover:text-orange-400"
            >
              <svg viewBox="0 0 24 24" fill="currentColor" className="h-5">
          ...
          <p className="mt-4 text-sm text-slate-300">
            Explore our social media platforms and delve deeper into our
            offerings.
          </p>
        </div>
      </div>
